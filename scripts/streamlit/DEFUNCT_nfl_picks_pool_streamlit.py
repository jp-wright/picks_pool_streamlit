...
def load_and_prep_data():
    ...
    dfreg = pd.read_csv('/Users/jpw/Dropbox/Data_Science/datasets/sports_data/NFL_databases/wiki_nfl_data/nfl_season_standings/nfl_regular_ssn_standings_pool_years.csv').drop('Team', 1)
    dfpost = pd.read_csv('/Users/jpw/Dropbox/Data_Science/datasets/sports_data/NFL_databases/wiki_nfl_data/nfl_season_standings/nfl_post_ssn_standings_pool_years.csv')
    dftot = pd.read_csv('/Users/jpw/Dropbox/Data_Science/datasets/sports_data/NFL_databases/wiki_nfl_data/nfl_season_standings/nfl_regular_plus_post_ssn_standings_pool_years.csv')
    ...
    <html>
      <body>
        <p>NOTE: this email is meant to be viewed with a light background/theme.
           ...
           Here's your weekly update {po_inc} as of {the_wk}! <BR>
...
# )
    ...
    # 
    # st.write(body_dct['nug_txt'])
    
    
    # st.write(body_dct['hist_intro_txt'])
