...
from utility.pickspool_styling import champ_hist
...
class DataPrepper():
    ...
    def prep_year_data_for_website(self, dfy: pd.DataFrame) -> pd.DataFrame:
        ...
        export_to_csv(frame, fname='year_data.csv', subdir='email_tables')
        return frame
    ...
    def prep_round_data_for_website(self, dfr: pd.DataFrame):
        ...
        frame.columns = [c.replace('_', ' ') for c in frame.columns]
        export_to_csv(frame, fname='round_data.csv', subdir='email_tables')
        return frame
    ...
    def prep_career_data_for_website(self, dfc: pd.DataFrame):
        ...
        frame.columns = [c.replace('_', ' ') for c in frame.columns]
        export_to_csv(frame, fname='career_data.csv', subdir='email_tables')
        return frame
    ...
    def prep_year_history(self, dfy: pd.DataFrame, highlight_year: int):
        ...
        export_to_csv(pd.concat(frames, axis=0), fname='year_hist_data.csv', subdir='email_tables')
        return frames
    ...
    def prep_player_teams_this_year(self, df: pd.DataFrame, curr_year: int):
        ...
        export_to_csv(frame, fname='player_teams_data.csv', subdir='email_tables')
        return frame
    ...
    def prep_champ_history(self, dfy: pd.DataFrame, highlight_year: int):
        ...
        frame[int_cols] = frame[int_cols].astype(int)
        export_to_csv(frame, fname='champ_data.csv', subdir='email_tables')
        return frame
    ...
    def prep_playoff_teams_this_year(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        export_to_csv(frame, fname='playoff_teams_data.csv', subdir='email_tables')
        return frame
    ...
    def prep_best_worst_picks_by_rd(self, df):
        ...
        export_to_csv(frame, fname='best_worst_picks_data.csv', subdir='email_tables')
        return frame
